...
function AppInner(){
  ...
  const reset=()=>{localStorage.removeItem("apex_paused_workout");clearDailyWorkout();setResumePrompt(null);setScreen("home");setTab("home");setExIdx(0);setReflectData(null);setCompletedExercises([]);setSessionStart(null);setCheckInData(null);setDifficulty("standard");setExHistory([]);
