...
function AppInner(){
  ...
  useEffect(()=>{
    ...
    if(screen==="auth"||screen==="init"){if(isQAEnabled()){setScreen("qa_panel");} else{const saved=(()=>{try{return localStorage.getItem("apex_last_screen");}catch{return null;}})();const restorable=new Set(["home","train","library","tasks","coach","profile","plan_view"]);if(saved&&restorable.has(saved)){setScreen(saved);}else{setScreen("home");}}}
  ...
  const navTo=useCallback(t=>{setTab(t);if(t==="home")setScreen("home");else if(t==="train")setScreen("train");else if(t==="library")setScreen("library");else if(t==="tasks")setScreen("tasks");else if(t==="wellness")setScreen("wellness");else if(t==="coach")setScreen("coach");},[]);
  ...
  return(<>
    ...
    {screen==="qa_panel"&&<QAPanel onClose={()=>{setScreen("home");setTab("home");}}/>}
