...
function BottomNav({active,onNav}){const _auth=useAuth();const _isDev=_auth?.user?.email==="johncarrus@gmail.com";const items=[{id:"home",label:"Home",icon:"🏠"},{id:"train",label:"Train",icon:"💪"},{id:"library",label:"Library",icon:"📚"},{id:"tasks",label:"Tasks",icon:"✅"},{id:"wellness",label:"Wellness",icon:"🧘"},{id:"coach",label:"Coach",icon:"🤖"},...(_isDev?[{id:"dev_test",label:"Dev",icon:"🔧"}]:[])];
