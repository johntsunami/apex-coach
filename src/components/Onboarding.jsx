  ...
  return (
    <div className="fade-in safe-bottom" style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      {screen === 12 && <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        {(() => {
          const TIME_INFO = {
            30: { icon: "🎯", title: "Focused session", sub: "Tight, intentional, results-driven", msg: "30 minutes is a completely legitimate training session — don't let anyone tell you otherwise. You'll get a proper warmup, 3-4 main exercises, your injury protocols, and a full cooldown. This is what sustainable consistency actually looks like. Done regularly, this changes your body.", tags: ["Full warmup & activation","3-4 main exercises","Injury protocol included","Cooldown & stretch","Core work every session"], nudge: "Most people who are in great shape train consistently in 30-45 minute sessions. You're in good company.", upsell: "15 more minutes unlocks a full extra movement pattern and meaningful additional volume." },
            45: { icon: "🔥", title: "The sweet spot", sub: "Where most results happen", badge: "Most recommended", msg: "45 minutes is where the science and real life meet. Research consistently shows this window drives strong adaptation without excessive fatigue. You'll cover every major movement pattern, hit your PT protocols, and walk out feeling accomplished — not wrecked. This is the tier most athletes and physique-focused training programs are built around.", tags: ["Full movement pattern coverage","5-6 main exercises","PT & rehab protocols","Sport-specific work","Complete cooldown","Progressive overload tracking"], nudge: "Enough stimulus to drive real change, enough recovery to keep coming back. The compounding effect of this done consistently is significant.", upsell: "15 more minutes adds accessory work and advanced techniques for faster results." },
            60: { icon: "💪", title: "Full power session", sub: "More volume, faster progress", msg: "60 minutes gives you room to go deeper, add meaningful volume, and work the details. You'll get more sets on your main lifts, proper accessory work, and real time for recovery protocols. This is where serious, consistent progress happens — and it's completely achievable as your regular training standard.", tags: ["7-8 main exercises","Accessory & isolation work","Full sport conditioning","Advanced techniques","Comprehensive recovery protocol","Maximum phase volume"], nudge: "More volume means more adaptation stimulus. Commit to 60 minutes consistently and your results will compound faster than almost any other variable you could control.", upsell: "30 more minutes is our elite tier — but 60 minutes already captures most of the benefit." },
            90: { icon: "🏆", title: "Elite training block", sub: "Maximum stimulus, maximum results", msg: "90 minutes is a full athlete session. You'll hit everything — comprehensive warmup, multiple movement patterns, accessory work, sport-specific conditioning, and a deep recovery protocol. This is how physique competitors and performance athletes train. One important thing: make sure your recovery matches the effort — sleep, nutrition, and rest days matter even more at this volume.", tags: ["Complete movement coverage","10+ exercises","Full sport conditioning","Advanced techniques","Deep recovery protocol","Maximum weekly volume","Bodybuilding & competition tracks"], nudge: "This is the full package. Commit to this consistently and your results will be undeniable. Recover as hard as you train.", upsell: null, recovery: "Recovery note: 90-min sessions require 7-9 hrs sleep and adequate protein to deliver their full results." },
          };
          ...
          return <><Card style={{ padding: 0, overflow: "hidden" }}>
              ...
              <div style={{ display: "flex", gap: 6 }}>
                {[30, 45, 60, 90].map(t => (
                  <button key={t} onClick={() => setPrefs(p => ({ ...p, sessionTime: t }))}
                    style={{ flex: 1, padding: "14px 4px", borderRadius: 12, cursor: "pointer", fontFamily: "inherit", textAlign: "center",
                    ...
                    <div style={{ fontSize: 22, fontWeight: 500 }}>{t}</div>
            ...
            <div style={{ padding: "12px 14px 14px", borderTop: `1px solid ${C.border}`, transition: "opacity 180ms ease" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                ...
                <div>
                  {info.badge && <span style={{ fontSize: 11, fontWeight: 700, color: C.teal, background: C.tealBg, padding: "3px 10px", borderRadius: 20, letterSpacing: 0.5, marginBottom: 2, display: "inline-block" }}>{info.badge}</span>}
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 4, marginBottom: 8 }}>
                {info.tags.map(tag => <span key={tag} style={{ fontSize: 10, padding: "3px 8px", borderRadius: 6, background: C.bgElevated, color: C.textMuted, border: `1px solid ${C.border}` }}>{tag}</span>)}
              </div>
          ...
          {/* Split session callout — always visible */}
          <Card style={{ padding: 0, overflow: "hidden", borderColor: C.teal + "25" }}>
            <div style={{ display: "flex" }}>
              <div style={{ width: 3, background: C.teal, flexShrink: 0 }} />
              <div style={{ padding: "16px 18px" }}>
                <div style={{ fontSize: 15, fontWeight: 500, color: C.text, marginBottom: 6, display: "flex", alignItems: "center", gap: 6 }}><span>🗓️</span> Can't do it all at once? Split it up.</div>
                <div style={{ fontSize: 13, color: C.textMuted, lineHeight: 1.6, marginBottom: 8 }}>Life happens. If you can't fit your full session in one go, APEX Coach lets you pause your workout and pick it up later in the day. Do your warmup in the morning, main exercises at lunch, and cooldown in the evening — it all counts toward your session. Your progress is saved between each block automatically.</div>
                <div style={{ display: "flex", alignItems: "center", gap: 4, marginBottom: 8 }}>
                  {[{icon:"☀️",l:"Morning warmup"},{icon:"🌤",l:"Lunch main lifts"},{icon:"🌙",l:"Evening cooldown"}].map((s, i) => <><span key={s.l} style={{ fontSize: 11, padding: "3px 8px", borderRadius: 6, background: C.bgElevated, color: C.textMuted }}>{s.icon} {s.l}</span>{i < 2 && <span style={{ color: C.textDim, fontSize: 10 }}>→</span>}</>)}
                </div>
                <div style={{ fontSize: 13, color: C.teal }}>The app tracks it all — one session, your pace.</div>
              </div>
            </div>
          </Card></>;
        })()}
